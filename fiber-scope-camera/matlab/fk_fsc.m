...
T01 = ModifiedDH(     0,  0, D1, q(1) );
T12 = ModifiedDH(  pi/2, L1,  0, q(2) );
T23 = ModifiedDH(  pi/2, L2,  0, q(3) );
T34 = ModifiedDH(  pi/2, L3,  0, q(4) );
T45 = ModifiedDH(  pi/2, L4,  0, q(5) );
T56 = ModifiedDH(  pi/2, L5,  0, q(6) );
