/*
	XY2LinkController1.cpp
		Solve inverse kinematics in initilize() by symbolic Jacobain
...
class XY2LinkController1 : public SimpleController
{
private:
...
CNOID_IMPLEMENT_SIMPLE_CONTROLLER_FACTORY(XY2LinkController1)
