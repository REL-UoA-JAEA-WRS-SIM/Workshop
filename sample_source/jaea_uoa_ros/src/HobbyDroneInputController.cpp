...
class HobbyDroneInputController : public SimpleController
{
public:
    ros::NodeHandle node;
    ...
    virtual bool initialize(SimpleControllerIO* io) override
    {
        ...
        joystickSubscriber = node.subscribe("joy", 1, &HobbyDroneInputController::joystickCallback, this);
...
CNOID_IMPLEMENT_SIMPLE_CONTROLLER_FACTORY(HobbyDroneInputController)
